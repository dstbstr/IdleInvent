...
namespace {
    ...
    std::unordered_map<Building, BaseTime> BuildingBaseTimeCost{
        {Building::Staff, TimeCosts.at(0)},
        {Building::Symbol, TimeCosts.at(0)},
        {Building::Shrine, TimeCosts.at(0)},
        {Building::Samurai, TimeCosts.at(1)},
        {Building::Militia, TimeCosts.at(1)},
        {Building::Castle, TimeCosts.at(1)},
        {Building::Army, TimeCosts.at(2)},
        {Building::Siegework, TimeCosts.at(2)},
        {Building::Navy, TimeCosts.at(2)},
        {Building::Kingdom, TimeCosts.at(3)},
        {Building::Empire, TimeCosts.at(3)},
        {Building::State, TimeCosts.at(3)},
        {Building::Diplomat, TimeCosts.at(4)},
        {Building::Embassy, TimeCosts.at(4)},
        {Building::Confederation, TimeCosts.at(4)},
        {Building::War, TimeCosts.at(5)},
        {Building::Occupation, TimeCosts.at(5)},
        {Building::Alliance, TimeCosts.at(5)},
        {Building::FirstContact, TimeCosts.at(6)},
        {Building::Decoding, TimeCosts.at(6)},
        {Building::Encoding, TimeCosts.at(6)},
        // Knowledge
        {Building::Holiday, TimeCosts.at(0)},
        {Building::Ceremony, TimeCosts.at(0)},
        {Building::History, TimeCosts.at(0)},
        {Building::Epistemology, TimeCosts.at(1)},
        {Building::Metaphysics, TimeCosts.at(1)},
        {Building::Ethics, TimeCosts.at(1)},
        {Building::ClayTablets, TimeCosts.at(2)},
        {Building::Pictogram, TimeCosts.at(2)},
        {Building::Alphabet, TimeCosts.at(2)},
        {Building::Pamphlet, TimeCosts.at(3)},
        {Building::PrintingPress, TimeCosts.at(3)},
        {Building::Library, TimeCosts.at(3)},
        {Building::PrimaryEducation, TimeCosts.at(4)},
        {Building::University, TimeCosts.at(4)},
        {Building::ResearchLabs, TimeCosts.at(4)},
        {Building::Computer, TimeCosts.at(5)},
        {Building::Server, TimeCosts.at(5)},
        {Building::DataCenter, TimeCosts.at(5)},
        {Building::Theory, TimeCosts.at(6)},
        {Building::ProofOfConcept, TimeCosts.at(6)},
        {Building::QuantumComputer, TimeCosts.at(6)},
        // Money
        {Building::Orchard, TimeCosts.at(0)},
        {Building::Field, TimeCosts.at(0)},
        {Building::Farm, TimeCosts.at(0)},
        {Building::Bazaar, TimeCosts.at(1)},
        {Building::Market, TimeCosts.at(1)},
        {Building::TradeRoute, TimeCosts.at(1)},
        {Building::Gold, TimeCosts.at(2)},
        {Building::Gem, TimeCosts.at(2)},
        {Building::FiatCurrency, TimeCosts.at(2)},
        {Building::Loan, TimeCosts.at(3)},
        {Building::Bank, TimeCosts.at(3)},
        {Building::Investment, TimeCosts.at(3)},
        {Building::Commoditiy, TimeCosts.at(4)},
        {Building::Company, TimeCosts.at(4)},
        {Building::Futures, TimeCosts.at(4)},
        {Building::CurrencyExchange, TimeCosts.at(5)},
        {Building::UnifiedCurrency, TimeCosts.at(5)},
        {Building::LivingWageLaw, TimeCosts.at(5)},
        {Building::CropCircle, TimeCosts.at(6)},
        {Building::UfoSighting, TimeCosts.at(6)},
        {Building::Abduction, TimeCosts.at(6)},
        // Power
        {Building::Hammer, TimeCosts.at(0)},
        {Building::Axe, TimeCosts.at(0)},
        {Building::Chisel, TimeCosts.at(0)},
        {Building::Dog, TimeCosts.at(1)},
        {Building::Horse, TimeCosts.at(1)},
        {Building::Cow, TimeCosts.at(1)},
        {Building::Wheel, TimeCosts.at(2)},
        {Building::Pulley, TimeCosts.at(2)},
        {Building::Lever, TimeCosts.at(2)},
        {Building::Silo, TimeCosts.at(3)},
        {Building::Warehouse, TimeCosts.at(3)},
        {Building::Workshop, TimeCosts.at(3)},
        {Building::Battery, TimeCosts.at(4)},
        {Building::Generator, TimeCosts.at(4)},
        {Building::Transformer, TimeCosts.at(4)},
        {Building::FissionReactor, TimeCosts.at(5)},
        {Building::WasteDisposal, TimeCosts.at(5)},
        {Building::FusionReactor, TimeCosts.at(5)},
        {Building::Rocket, TimeCosts.at(6)},
        {Building::Satellite, TimeCosts.at(6)},
        {Building::SpaceStation, TimeCosts.at(6)}
    };
