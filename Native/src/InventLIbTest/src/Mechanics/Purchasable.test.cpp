...
namespace Invent {
	struct TestPurchasable : public Purchasable {
		TestPurchasable(ResourceCollection costs, Purchasable::OnPurchaseFn onPurchase)
			: Purchasable("TestPurchasable", costs, onPurchase)
		{}
	};
	...
	struct PurchasableTest : public testing::Test {
		...
		ResourceCollection LargeCollection{ {{ResourceName::Influence, 1000}, {ResourceName::Knowledge, 1000}, {ResourceName::Labor, 1000}, {ResourceName::Magic, 1000}, {ResourceName::Wealth, 1000}} };
